...
1. Download the pretrained model [here](https://drive.google.com/file/d/1aqNmy5YFubmvWMBtpjtpdIABkF7LvdBU/view?usp=share_link) and put it to `$ROOT/data/model/snake/kins/`.
2. Test:
    ```
...
1. Download the pretrained model [here](https://drive.google.com/file/d/1SWU3erDgePcIHIOWpW11dJomXb39ORw8/view?usp=share_link) and put it to `$ROOT/data/model/snake/coco/`.
2. Test:
    ```
